    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="container" style="background: white">
                <h1 id="txt_opcion_menu_vertical"><span class="negrita">Editar datos de tutoría presencial - grupal</span></h1>
                <hr>
                <form action="{{url("confirmar_tutoria")}}" method="POST">
                    ...
                    <div class="container" id="fondo_blanco">
                        <h6 id="txt_opcion_menu_vertical"><span class="negrita">Datos de tutoría</span></h6>
                        <hr>
                        <h6 id="txt_opcion_menu_vertical">
                            <span class="negrita">Día:</span>
                            <span class="quita_negrita"><input type="hidden" name="dia" value="{{$datos_tut->dia}}">{{$datos_tut->dia}}</span>
                            <br>
                            <br>
                            <div class="row">
                                @if ($aux==1)
                                    <div class="col-3">
                                        <h6 class="negrita">Hora inicio 
