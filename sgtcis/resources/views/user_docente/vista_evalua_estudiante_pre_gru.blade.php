                                ...
                                <form action="{{url("evaluacion_estudiante/{$user_estudiante->id}/{$solitutoria_id}")}}" method="POST" onsubmit="return validar_evaluacion_estudiante()">
                                    ...
                                    <div class="container" id="fondo_solicitud"> 
                                        ...
                                        <table class="table table-bordered table-sm">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1. ¿Considera que los integrantes del grupo leen el material (artículos, libros, documentos) facilitado o recomendado en clase?</td>
                                                    <td>
                                        ...
                                        <table class="table table-bordered table-sm">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>2. ¿El conocimiento previo del grupo sobre el tema de tutoría fué?</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>3. ¿El interés y disposición del grupo durante la tutoría fué?</td>
                                                    <td>
                                                        <span class="hint--bottom" data-hint="Muy alto">
                                                ...
                                                <tr>
                                                    <td>4. ¿El desempeño (preguntó sobre nuevas dudas del tema) del grupo durante la tutoría fué?</td>
                                                    <td>
                                                        <span class="hint--bottom" data-hint="Muy alto">
                                                ...
                                                <tr>
                                                    <td>5. En general ¿cómo califica la participación del grupo durante la tutoría?</td>
                                                    <td>
                                                        <span class="hint--bottom" data-hint="Muy alto">
