        ...
        <div class="list-group list-group-flush">
            <div class="vertical-menu">
                <ul class="menu_vertical">
                                    ...
                                    @if (auth()->user()->unreadNotifications->count())
                                        @foreach (auth()->user()->unreadNotifications as $notifications)
                                            ...
                                            @if ($valida_invita_estudiante==true)
                                                @php
                                                    $v_solitutoria=DB::table('solitutorias')->where('id',$notifications->data['invita_estudiante']['solitutoria_id'])->exists();
                                                @endphp
                                                ...
                                                @else
                                                    <a href="{{url("invitacion_eliminada/{$notifications->id}/{$notifications->data['invita_estudiante']['solitutoria_id']}")}}" class="droptdown-item">
                                                        <span class="fas fa-envelope"></span>
                                                        {{$notifications->data['invita_estudiante']['descripcion']}} <br>
                                                        <span class="titulo_fecha_tutoria">{{$notifications->data['invita_estudiante']['created_at']}}</span>
                                                    </a>
                  ...
                  <li>
                    <a href="{{url("vista_tut_sol_est")}}"><i class="icono izquierda far fa-eye"></i>Vista tutorías</a>
                  </li>
